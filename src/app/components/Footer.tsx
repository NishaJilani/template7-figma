...
export default function Footer() {
  return (
    <footer className="relative flex flex-col items-center space-y-6 px-6 w-full bg-white py-8 lg:h-screen">
      ...
      <div className="w-full flex flex-col lg:flex-row items-start justify-between gap-8">
        ...
        <div className="brand flex flex-col space-y-3 w-full lg:w-1/3">
          <h1 className="text-blue-600 text-3xl font-extrabold text-center lg:text-left max-w-md">
            MORENT
          </h1>
        ...
        <div className="links flex flex-wrap justify-center lg:justify-end gap-8 w-full lg:w-2/3 mb-5 text-black">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-4 text-black">
