...
export default function page() {
  return (
    <div className="w-full flex">
      ...
      <div className="sec w-full sm:w-[75%] bg-[#f6f7f9] p-4 sm:p-6  flex flex-col gap-10 font-serif">
        <section className=" w-full flex flex-col md:flex-row gap-5  items-center justify-around">
          <div className="first flex flex-col gap-4 w-full  lg:max-w-[470px]  lg:max-h-[508px]">
            <div>
              <Image src={"/Car-view.png"} alt="" width={492} height={360} />
            </div>
            <div className=" flex items-center justify-between gap-2 lg:gap-2">
              <Image src={"/Car-View-1.png"} alt="" width={148} height={124} />
              <Image src={"/Car-View-2.png"} alt="" width={148} height={124} />
              <Image src={"/Car-View-3.png"} alt="" width={148} height={124} />
            </div>
          </div>
          <div className="flex flex-col w-full lg:max-w-[492px] h-auto lg:max-h-[508px] bg-white justify-between rounded-xl shadow-md">
            ...
            <div className="p-4 flex items-center gap-4">
              ...
              <Link href="/PaymentPage">
                <button className="bg-[#3563e9] hover:bg-[#3955aa] px-6 py-3 sm:px-10 sm:py-4 text-white rounded-md w-full max-w-[200px] whitespace-nowrap">
                  Rent Now
                </button>
              </Link>
            </div>
