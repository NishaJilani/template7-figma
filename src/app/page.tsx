    ...
    <div className="bg-[#f6f7f9] min-h-screen p-4 sm:p-6 lg:p-20 flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
      ...
      >
        <div className="relative flex flex-col items-center">
          ...
          />
          <button className="absolute bottom-20 left-1 m-3 bg-blue-600 text-white font-normal py-2 px-4  rounded hidden">
            Rental Car
          </button>
        </div>
        ...
        <div className="relative flex flex-col items-center">
          <Image
            ...
            className="max-w-full"
          />
          <button className="absolute bottom-20 left-1 m-3 bg-blue-400 text-white font-normal py-2 px-4 rounded hidden ">
            Rental Car
          </button>
        </div>
      </section>
      ...
      >
        ...
        <div className="w-[60px] h-[60px] bg-blue-600 hover:bg-blue-500 rounded-lg flex items-center justify-center">
          <Image src="/Switch1.png" alt="Switch Icon" width={50} height={50} />
        </div>
